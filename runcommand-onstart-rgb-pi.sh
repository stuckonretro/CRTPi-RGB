...
#NEW 1920x240: 1920 1 52 208 260 240 1 6 10 6 0 0 0 60 0 38400000 1
#
#NEW 1920x224: 1920 1 52 208 260 224 1 14 10 14 0 0 0 60 0 38400000 1
#
#NEW 1920x200: 1920 1 52 208 260 200 1 26 10 26 0 0 0 60 0 38400000 1
#
#NEW 1920x192: 1920 1 52 208 260 192 1 30 10 30 0 0 0 60 0 38400000 1
#=====================================================================================================================================
...
# change timings for 320.txt to 1920x240p
		...
		vcgencmd hdmi_timings 1920 1 52 208 260 240 1 6 10 6 0 0 0 60 0 38400000 1 > /dev/null #CRTPi 1920x240p Timing Adjusted
		tvservice -c "DMT 87" > /dev/null
...
# change timings for 320x224 & 384x224 systems to 1920x224p
		...
		[[ "$system" == "fba" ]] || 
		[[ "$system" == "neogeo" ]] ; then
			vcgencmd hdmi_timings 1920 1 52 208 260 224 1 14 10 14 0 0 0 60 0 38400000 1 > /dev/null #CRTPi 1920x224p Timing Adjusted
			tvservice -c "DMT 87" > /dev/null
...
# change timings for 320x200 systems to 1920x200p
		...
		[[ "$system" == "quake" ]] || 
		[[ "$system" == "doom" ]] ; then
			vcgencmd hdmi_timings 1920 1 52 208 260 200 1 26 10 26 0 0 0 60 0 38400000 1 > /dev/null #CRTPi 1920x200p Timing Adjusted
			tvservice -c "DMT 87" > /dev/null
...
# change timings for 320x192 systems to 1920x192p
		...
		[[ "$system" == "zxspectrum" ]] ; then
			vcgencmd hdmi_timings 1920 1 52 208 260 192 1 30 10 30 0 0 0 60 0 38400000 1 > /dev/null #CRTPi 1920x192p Timing Adjusted
			tvservice -c "DMT 87" > /dev/null
